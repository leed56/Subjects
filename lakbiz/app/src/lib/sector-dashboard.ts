...
const PRESETS: Record<SectorId, SectorDashboardPreset> = {
  ...
  textile: {
    ...
    onboardingTitleEn: "Prepare roll-aware textile stock",
    onboardingTitleSi: "Roll අනුව රෙදි තොගය සූදානම් කරන්න",
    onboardingDescriptionEn: "Create fabric styles with width, colour, shade and selling unit before receiving physical rolls.",
    onboardingDescriptionSi: "භෞතික roll ලබාගැනීමට පෙර පළල, වර්ණය, shade සහ අලෙවි ඒකකය සමඟ රෙදි වර්ග සාදන්න.",
    onboardingStepsEn: ["Create fabric catalogue", "Set metre/yard and wholesale pricing", "Receive rolls and begin measured sales"],
    onboardingStepsSi: ["රෙදි ලැයිස්තුව සාදන්න", "මීටර්/යාර සහ තොග මිල සකසන්න", "Roll ලබාගෙන මිනුම් අලෙවිය ආරම්භ කරන්න"],
    primaryAction: { href: "/stock", labelEn: "Add fabric", labelSi: "රෙදි එක් කරන්න" },
  },
  ac_hvac: {
